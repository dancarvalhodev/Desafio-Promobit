...
<div class="card p-4" style="width: 100%;">
  <div class="card-body">
    <h5 class="card-title text-center">Edição do Produto</h5>
    <div class="text-center alert alert-danger">
        <strong>Atenção: Ao editar a tag já existente, o nome será automaticamente atualizado!</strong>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <form action="/edit-product" method="post">
                ...
                <div class="text-center">
                    <button type="submit" class="btn  btn-size btn-primary">Salvar</button>
                </div>
            </form>
        </div>
    </div>
